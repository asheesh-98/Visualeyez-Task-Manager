...
import { Calendar, Flag, MoreHorizontal, Trash2, Edit3, CheckCircle2, Circle, Clock, GripVertical, ChevronDown, ChevronRight, Plus, X } from 'lucide-react';
                ...
                <div className="mt-3 pt-3 border-t border-border space-y-1.5">
                  ...
                  {addingSubtask ? (
                    <div className="flex items-center gap-1.5 mt-1">
                      ...
                      <Button size="sm" variant="ghost" onClick={() => { setAddingSubtask(false); setNewSubtask(''); }} className="h-7 px-2 text-xs">
                        <X size={12} />
                      </Button>
                    </div>
                  ) : (
